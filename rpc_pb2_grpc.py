...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ping = channel.unary_unary(
                ...
                request_serializer=rpc__pb2.Ping.SerializeToString,
                response_deserializer=rpc__pb2.Pong.FromString,
                )
...
def add_PingPongServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ping': grpc.unary_unary_rpc_method_handler(
                    servicer.ping,
                    request_deserializer=rpc__pb2.Ping.FromString,
                    response_serializer=rpc__pb2.Pong.SerializeToString,
            ),
    }
...
class PingPongService(object):
    ...
    def ping(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PingPongService/ping',
            rpc__pb2.Ping.SerializeToString,
            rpc__pb2.Pong.FromString,

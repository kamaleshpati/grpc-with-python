...
class Listener(rpc_pb2_grpc.PingPongServiceServicer):
    ...
    def ping(self, request, context):
        ...
        if self.counter > 10000:
            ...
            self.last_print_time = time.time()
            self.counter = 0
        return rpc_pb2.Pong(count=request.count + 1)
...
def serve():
    ...
    rpc_pb2_grpc.add_PingPongServiceServicer_to_server(Listener(), server)
